...
/**
 * @author xbguo
 * @createTime 2022年04月23日 15:22:00
 * 招商银行-01. 文本编辑程序设计
 * 通过的用户数712
 * 尝试过的用户数736
 * 用户总通过次数722
 ...
 */
public class Code01_0423 {
    public static void main(String[] args) {
        Code01_0423 code01_0423 = new Code01_0423();
        String s = code01_0423.deleteText("Hello World", 6);
    ...
    public String deleteText(String article, int index) {
        ...
        if (c == ' ') {
            ...
            if (left == 0) {
                stringBuilder.append(article, right+1, length);
            } else if (right == length - 1) {
                stringBuilder.append(article, 0, left);
            } else {
                stringBuilder.append(article, 0, left).append(article, right, length);
            }
