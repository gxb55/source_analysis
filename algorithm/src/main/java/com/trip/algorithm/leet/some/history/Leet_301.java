...
/**
 * @author xbguo
 * @createTime 2022年04月06日 21:51:00
 * 310. 最小高度树
 ...
 * 通过次数41,012提交次数97,785
 */
public class Leet_301 {
    public static void main(String[] args) {
        int n = 6;
        int[][] edges =
                {{3, 0}, {3, 1}, {3, 2}, {3, 4}, {5, 4}};

        Leet_301 leet_301 = new Leet_301();
        List<Integer> minHeightTrees = leet_301.findMinHeightTrees(n, edges);
        System.out.println(minHeightTrees);
    }

    /**
     * arr 和 list中的下标代表啥
     * arr的下标代表具体元素 i的出度是多少，即他指向那几个
     * list中的下标代表具体元素i的出度的点分别是那几个
     * @param n
     * @param edges
     * @return
     */
