...
/**
 * @author xbguo
 * @createTime 2023年03月05日 09:32:00
 * 1599. 经营摩天轮的最大利润
...
public class Solution1599 {
    public static void main(String[] args) {
      ...
      /*  int[] customers = {10, 9, 6};
        ...
        int i = minOperationsMaxProfit(customers, boardingCost, runningCost);
    ...
    public static int minOperationsMaxProfit(int[] customers, int boardingCost, int runningCost) {
        ...
        for (int i = 0; i < customers.length; i++) {
            ...
            sum = sum + cur;
           /* if (list.size() > 4) {
                sum = sum - list.pollFirst();
            }*/
            k = sum * boardingCost - t * runningCost;
            t++;
            if (k > max) {
                max = k;
                count = res;
